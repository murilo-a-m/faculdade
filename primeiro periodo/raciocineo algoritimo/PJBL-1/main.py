...
print("Tendo um aproveitamento de", percentual_vitorias_jogador1," em suas vitórias e um percentual de", percentual_jogadas_jogador1, "em suas jogadas certas")
...
print("Tendo um aproveitamento de", percentual_vitorias_jogador2," em suas vitórias e um percentual de", percentual_jogadas_jogador2, "em suas jogadas certas")
